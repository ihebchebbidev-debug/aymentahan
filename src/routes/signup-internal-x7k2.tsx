...
import { DEFAULT_USER_AGENCY_TEAMS, DEFAULT_USER_AGENCY_TEAM } from "@/lib/userAgencyTeams";
...
function SignupPage() {
  ...
  const [form, setForm] = useState({
    username: "", fullName: "", email: "", password: "", team: DEFAULT_USER_AGENCY_TEAM,
  });
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select value={form.team} onValueChange={(v) => setForm((f) => ({ ...f, team: v }))}>
              ...
              <SelectContent>
                {DEFAULT_USER_AGENCY_TEAMS.map((t) => <SelectItem key={t} value={t}>{t}</SelectItem>)}
              </SelectContent>
            </Select>
          </div>
