...
function ProspectDetailPage() {
  ...
  // Lead change history: Admin always granted via AuthProvider; others need the explicit `lead.history` permission.
  ...
  if (prospect.assignedTo && prospect.assignedTo !== user?.username && !hasPermission("prospect.view_all")) {
    return (
      <AppLayout skeleton="detail">
        <div className="p-10 text-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    {types.length > 0 && (
                      <div className="space-y-1.5">
                        ...
                        <Select value={prospect.typeId ?? "__none__"} onValueChange={changeType} disabled={!canChangeType}>
