  ...
  switch (scope) {
    case "prospects":
      return withCf([
        ...
        { key: "dateModifFrom", label: "Modifié du", type: "date" },
        { key: "dateModifTo", label: "Modifié au", type: "date" },
        { key: "dateModif", label: "Modifié le (exact)", type: "date" },
    ...
    case "opportunities":
      return withCf([
        ...
        { key: "dateModifFrom", label: "Modifiée du", type: "date" },
        { key: "dateModifTo", label: "Modifiée au", type: "date" },
        { key: "dateModif", label: "Modifiée le (exact)", type: "date" },
