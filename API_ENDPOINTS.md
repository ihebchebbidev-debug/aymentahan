...
**Base URL:** `https://erp.ttshop.pro/code_source/backend/php`
...
### Test Health
```bash
curl https://erp.ttshop.pro/code_source/backend/php/health.php
```

### Test Login
```bash
curl -X POST https://erp.ttshop.pro/code_source/backend/php/auth_login.php \
...
```bash
curl -X GET "https://erp.ttshop.pro/code_source/backend/php/auth_me.php" \
...
### Test Get Prospects
```bash
curl -X GET "https://erp.ttshop.pro/code_source/backend/php/prospects.php" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "X-Auth-Token: YOUR_TOKEN"
```
...
### Test Get Dashboard
```bash
curl -X GET "https://erp.ttshop.pro/code_source/backend/php/dashboard.php" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "X-Auth-Token: YOUR_TOKEN"
```
...
- **DB User:** `ttshopvente`
- **Frontend Base:** `https://erp.ttshop.pro/code_source/`
