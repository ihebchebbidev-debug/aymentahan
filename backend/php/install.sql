...
INSERT IGNORE INTO crminternet_contracts
  ...
  ('C-2001','Khelifi','Amira','Tunis','APRIL','Cabinet Tunis 1', DATE_SUB(CURDATE(),INTERVAL 3 DAY), CURDATE(),                              CURDATE(),                              1850.00,'Validé Confirmation',     'Facebook','ines.vente',  'CS-3','OPP-2'),
...
INSERT IGNORE INTO crminternet_role_permissions (role, permission, enabled) VALUES
  ...
  ('Administrateur','page.backoffice',1),
  ('Administrateur','page.stages',1),('Administrateur','page.reports',1),
  ('Administrateur','page.objectives',1),
  ...
  ('Manager','page.backoffice',1),
  ('Manager','page.stages',1),('Manager','page.reports',1),
  ('Manager','page.objectives',1),
...
INSERT IGNORE INTO crminternet_role_permissions (role, permission, enabled) VALUES
  ('Manager','prospect.view',1),('Manager','prospect.add',1),('Manager','prospect.edit',1),('Manager','prospect.type',1),
  ...
  ('Manager','opportunity.view',1),('Manager','opportunity.edit',1),('Manager','opportunity.assign_prospect',1),('Manager','opportunity.change_prospect_type',1),('Manager','opportunity.convert',1),
  ...
  ('Agent','prospect.convert',1),('Agent','opportunity.view',1),('Agent','opportunity.edit',1),('Agent','opportunity.assign_prospect',1),('Agent','opportunity.change_prospect_type',1),
  ...
  ('AgentSuivi','prospect.view',1),('AgentSuivi','prospect.edit',1),('AgentSuivi','prospect.type',1),('AgentSuivi','prospect.convert',1),
  ('AgentSuivi','opportunity.view',1),('AgentSuivi','opportunity.edit',1),('AgentSuivi','opportunity.assign_prospect',1),('AgentSuivi','opportunity.change_prospect_type',1),
  ...
  ('AgentActivation','prospect.view',1),('AgentActivation','prospect.edit',1),('AgentActivation','prospect.type',1),
  ('AgentActivation','prospect.convert',1),('AgentActivation','opportunity.view',1),
  ('AgentActivation','opportunity.edit',1),('AgentActivation','opportunity.assign_prospect',1),('AgentActivation','opportunity.change_prospect_type',1),('AgentActivation','task.add',1),
  ...
  ('AgentVente','prospect.view',1),('AgentVente','prospect.add',1),('AgentVente','prospect.edit',1),('AgentVente','prospect.type',1),
  ('AgentVente','opportunity.assign_prospect',1),('AgentVente','opportunity.change_prospect_type',1),('AgentVente','task.add',1),('AgentVente','task.complete',1),
