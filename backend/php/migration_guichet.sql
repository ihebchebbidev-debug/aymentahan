...
-- Entités par défaut (idempotent — voir aussi production_guichet_entities.php)
INSERT IGNORE INTO crminternet_guichet_entities (id, name, type, city, active, created_at) VALUES
  ('GE-ttshop001',   'TTshop',             'ttshop',    'Tunis',     1, '2026-05-12 08:27:05'),
  ('GE-frakouda01',  'Franchise Akouda',   'franchise', 'Akouda',    1, '2026-05-12 08:27:05'),
  ('GE-frmahdia01',  'Franchise Mahdia',   'franchise', 'Mahdia',    1, '2026-05-12 08:27:05'),
  ('GE-frmonast01',  'Franchise Monastir', 'franchise', 'Monastir',  1, '2026-05-12 08:27:05'),
  ('GE-frsousse01',  'Franchise Sousse',   'franchise', 'Sousse',    1, '2026-05-12 08:27:05');