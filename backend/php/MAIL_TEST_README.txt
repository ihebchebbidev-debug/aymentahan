...
1) Static file (no PHP):
   http://www.api-test.animacom.com.tn/code_source/backend/php/ping.txt
   MUST show: STATIC OK

2) Minimal PHP:
   http://www.api-test.animacom.com.tn/code_source/backend/php/test_php_ping.php
   MUST show: PHP OK 8.x

3) API health (already on server):
   http://www.api-test.animacom.com.tn/code_source/backend/php/health.php
   MUST show: JSON {"ok":...}

4) Mail test:
   http://www.api-test.animacom.com.tn/code_source/backend/php/test_native_mail.php?token=crm-mail-test-2026
