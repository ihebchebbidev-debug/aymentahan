...
if ($method === 'GET') {
    ...
    $sql .= " ORDER BY c.earned_at DESC, c.id DESC LIMIT $listLimit OFFSET $offset";
    ...
    ok(['commissions' => $rows, 'summary' => $summary, 'limit' => $listLimit, 'offset' => $offset,
        'has_more' => count($rows) >= $listLimit]);
}
