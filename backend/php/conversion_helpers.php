...
function conversion_insert_contract_from_opportunity(PDO $db, string $cid, array $o, array $extra = []): void {
    ...
    $params = [
        ':id'   => $cid,
        ':oid'  => conv_v($o, 'id', null),
        ':pid'  => conv_v($o, 'prospect_id', null),
        ':civ'  => conv_v($o, 'civility', 'M'),
        ':ln'   => conv_v($o, 'last_name', ''),
        ':fn'   => conv_v($o, 'first_name', ''),
        ':ph'   => conv_v($o, 'phone', ''),
        ':ph2'  => conv_v($o, 'phone2', ''),
        ':anim' => conv_v($o, 'animateur', null),
        ':anc'  => conv_v($o, 'ancien_ligne', null),
        ':cin'  => (conv_v($o, 'cin', null) ?: null),
        ':bd'   => conv_v($o, 'birth_date', null),
        ':em'   => conv_v($o, 'email', ''),
        ':ci'   => conv_v($o, 'city', ''),
        ':gv'   => conv_v($o, 'gouvernorat', ''),
        ':dl'   => conv_v($o, 'delegation', ''),
        ':zn'   => conv_v($o, 'zone', ''),
        ':ad'   => conv_v($o, 'address', ''),
        ':gps'  => conv_v($o, 'localisation_xy', null),
        ':cp'   => conv_v($o, 'code_postal', null),
        ':c1'   => conv_v($o, 'comment1', null),
        ':c2'   => $comment2,
        ':src'  => conv_v($o, 'source', 'Web') ?: 'Web',
        ':tid'  => conv_v($o, 'type_id', conv_v($o, 'typeId', null)),
        ':lst'  => $leadStatus,
        ':pa'   => conv_v($extra, 'partner', ''),
        ':ca'   => conv_v($extra, 'cabinet', 'Cabinet Paris 1'),
        ':sd'   => conv_v($extra, 'signature_date', $today),
        ':ed'   => conv_v($extra, 'effective_date', conv_v($extra, 'signature_date', $today)),
        ':pr'   => (float)(conv_v($extra, 'premium', conv_v($o, 'amount', 0))),
        ':bs'   => conv_v($extra, 'billing_status', 'Pré-validé'),
